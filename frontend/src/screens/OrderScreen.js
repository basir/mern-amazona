            ...
            <Card.Body>
              ...
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Items</Col>
                    <Col>{order.itemsPrice.toFixed(2)}TL</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>Kargo</Col>
                    <Col>{order.shippingPrice.toFixed(2)}TL</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    <Col>vergi</Col>
                    <Col>{order.taxPrice.toFixed(2)}TL</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item>
                  <Row>
                    ...
                    <Col>
                      <strong>{order.totalPrice.toFixed(2)} TL</strong>
                    </Col>
                  </Row>
                </ListGroup.Item>
                {!order.isPaid && (
